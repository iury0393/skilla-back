...
exports.me = asyncHandler(async (req, res, next) => {
  const { avatar, username, fullname, email, _id, website, bio, followersCount, followers, followingCount, following, postCount, posts, createdAt } = req.user;

  res
    .status(200)
    .json({
      success: true,
      data: { avatar, username, fullname, email, _id, website, bio, followersCount, followers, followingCount, following, postCount, posts, createdAt },
    });
});
